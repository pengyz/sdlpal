...
public:
    ...
    BOOL isWINVersion(BOOL* pfIsWIN95);
    void initGameData(INT iSaveSlot);
...
private:
    ...
    INT loadGame(int iSaveSlot);
    INT loadGame_WIN(int iSaveSlot);
    INT loadGame_DOS(int iSaveSlot);
    BOOL loadGame_Common(int iSaveSlot, LPSAVEDGAME_COMMON s, size_t size);

private:
    LPGLOBALVARS _globals = nullptr;
    BOOL isWIN95 = FALSE;
    char pszSavePath[3] = { '.', '/', '\0' };
};
