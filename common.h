...
#ifndef PAL_HAS_MP3
#define PAL_HAS_MP3 \
  1 /* Try always enable MP3. If compilation/run failed, please change this value to 0. */
#endif
#ifndef PAL_HAS_OGG
#define PAL_HAS_OGG \
  1 /* Try always enable OGG. If compilation/run failed, please change this value to 0. */
#endif
#ifndef PAL_HAS_OPUS
#define PAL_HAS_OPUS \
  1 /* Try always enable OPUS. If compilation/run failed, please change this value to 0. */
#endif
...
#define PAL_fread(buf, elem, num, fp) \
  if (fread((buf), (elem), (num), (fp)) < (num)) return -1
